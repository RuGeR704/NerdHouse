...
public class TShirtServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        // Recupera i prodotti della categoria "T-Shirt"
        ...
        List<Categoria> categorie = categoriaDAO.doRetrievebyNome("T-Shirt");
        ...
        request.getRequestDispatcher("/WEB-INF/t-shirt.jsp").forward(request, response);
    }
}
