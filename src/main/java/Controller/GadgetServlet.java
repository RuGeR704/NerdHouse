...
public class GadgetServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        // Recupera i prodotti della categoria "G&A"
        ...
        List<Categoria> categorie = categoriaDAO.doRetrievebyNome("Gadget & Accessori");
        ...
        request.getRequestDispatcher("/WEB-INF/gadget.jsp").forward(request, response);
    }
}
